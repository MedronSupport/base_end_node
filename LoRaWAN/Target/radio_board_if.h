...
/* RF switch control lines of the Wio-E5 module (labels come from the .ioc)
 *   RX      : PA4 = 1, PA5 = 0
 *   TX (HP) : PA4 = 0, PA5 = 1
 */
#define RBI_RF_SW_CTRL1_PORT                RF_CTRL1_GPIO_Port
#define RBI_RF_SW_CTRL1_PIN                 RF_CTRL1_Pin
#define RBI_RF_SW_CTRL2_PORT                RF_CTRL2_GPIO_Port
#define RBI_RF_SW_CTRL2_PIN                 RF_CTRL2_Pin
#define RBI_RF_SW_CLK_ENABLE()              __HAL_RCC_GPIOA_CLK_ENABLE()
